...
public:
    ...
    VirtualTimer(uint32_t duration_ms, std::function<void(void)> task_func, Type timer_type, uint32_t max_duration_ms);
    VirtualTimer(uint32_t duration_ms, std::function<void(void)> task_func, Type timer_type, uint32_t max_calls);
